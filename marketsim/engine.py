...
def new_session(
    ...
    *,
    ...
    mkt = Market(
        ...
        chaos_flash_crash=c.chaos_flash_crash,
        chaos_meme_squeeze=c.chaos_meme_squeeze,
        chaos_fat_finger=c.chaos_fat_finger,
        chaos_exchange_halt=c.chaos_exchange_halt,
        chaos_rumor_mill=c.chaos_rumor_mill,
        chaos_sector_rotation=c.chaos_sector_rotation,
        chaos_funding_panic=c.chaos_funding_panic,
        chaos_liquidity_drought=c.chaos_liquidity_drought,
        chaos_whale_rebalance=c.chaos_whale_rebalance,
        chaos_crypto_weekend_mania=c.chaos_crypto_weekend_mania,
